    ...
    <section className="p-wrapper">
      <div className="innerWidth p-container">
        <div className="p-header">
          <span className="p-header-text ">Cloud Security Challenges We Solve</span>
        </div>
                        ...
                        data.map((item,i)=>{
                            ...
                            <AccordionItemHeading>
                                <AccordionItemButton className="accordionButton" >
                                    ...
                                    <div className=" icon"><img src={ warningLogo } alt="" /></div>
                                    <span className="p-accord-headings ">{item.heading}</span>
                                    <div className="icon arrowIcon"><MdOutlineArrowDropDown size={20} /></div>
                                    </div>
