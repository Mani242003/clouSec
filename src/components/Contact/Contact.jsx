...
const Contact = () => {
  return (
    <section className="c-wraper" id="contact">
      <motion.div
        className="innerWidth  c-container"
          ...
          <div className="c-left ">
            <div className="c-row1 row modesContainer">
              <div className="c-mode-1 mode">
                ...
                <div className="c-mode-button">
                  <a href="tel:+91 9345336553">Call Now</a>
                </div>
              </div>
              <div className="c-mode-2 mode">
                ...
                <div className="c-mode-button">
                  <a href="sms://+91 9840068989">Message Now</a>
                </div>
              </div>
            </div>
            <div className="c-row-2 row">
              <div className="c-mode-3 mode">
                ...
                <div className="c-mode-button">
                  <a href="https://stigmatatech.com" target="_blank">
                    Visit Now
                  </a>
                </div>
              </div>
              <div className="c-mode-4 mode">
                ...
                <div className="c-mode-button">
                  <a href="mailto:jerome.stigmata@gmail.com">Mail Now</a>
                </div>
              </div>
            </div>
          </div>
